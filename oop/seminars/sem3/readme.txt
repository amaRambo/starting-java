...
2.2. Играть, выводящий на экран фразу "Я играю Brawi Stars"
...
В классе Program в методе тап создать массив школьников. 
Так же создать метод, принимающий объект школьника и вызывающий 
все его методы